...
void loop() {
  ...
  if(!client.loop())
    client.connect(mqtt_client_id, mqtt_client_user, mqtt_client_pass);
    // client.connect(mqtt_client_id, mqtt_client_pass);

  // Publishes Temperature and Humidity values
//   client.publish("room/temperature", "TEST");
//   client.publish("room/humidity", "TEST");
}